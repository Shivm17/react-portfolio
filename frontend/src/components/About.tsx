      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <p className="text-lg leading-relaxed text-gray-300">
            ...
            frontend and backend technologies. My journey in web development has
            equipped me with a deep understanding of modern web technologies and
            best practices. I love creating seamless user experiences and robust
            server solutions.
          </p>
            ...
            <ol className="relative border-l border-gray-200 dark:border-gray-700">
              <li className="mb-10 ml-4">
                ...
                <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
                  completes my higher secondary from the pioneer school of
                  science
                </p>
              </li>
              <li className="mb-10 ml-4">
